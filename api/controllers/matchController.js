...
export const getUserProfiles = async (req, res) => {
	try {
		...
		const users = await User.find({
			$and: [
				{ _id: { $ne: currentUser.id } }, // not equal to current user
				{ _id: { $nin: currentUser.likes } }, // not in likes
				{ _id: { $nin: currentUser.dislikes } }, // not in dislikes
				{ _id: { $nin: currentUser.matches } }, // not in matches
				{
					gender:
